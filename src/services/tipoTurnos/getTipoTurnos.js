...
import { mockTiposTurnosService } from "../../mocks/mockServices.js";

const getTipoTurnos = async (page= 1) => {
    // MODO DEMO: Usar servicio mockeado
    return await mockTiposTurnosService.getAll();
